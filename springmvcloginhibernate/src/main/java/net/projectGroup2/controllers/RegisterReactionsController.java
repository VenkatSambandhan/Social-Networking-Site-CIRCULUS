...
@Controller
@RequestMapping("registerreactions.html")
public class RegisterReactionsController {
//	@Autowired
//	private CreatePostValidation createpostValidation;
	...
	public String showForm(HttpServletRequest request, Map model) {
		...
		session.setAttribute("vote",request.getParameter("vote"));
		...
		createcommentservice.newVote((Long)session.getAttribute("post_id"),(String)session.getAttribute("username"),(String)session.getAttribute("vote"));
	...
	// Process the form.
		@RequestMapping(method = RequestMethod.POST)
			public String processPost(@Valid RegisterReaction registerReactions,
				BindingResult result, HttpServletRequest request) {
			//System.out.println("Ciao.....");
			HttpSession session = request.getSession();
			//System.out.println(registerReactions.getComment());
			//System.out.println(session.getAttribute("post_id"));
			registerReactions.setPostId((Long) session.getAttribute("post_id"));
			...
			boolean viewResult = createcommentservice.newReaction
					((Long)session.getAttribute("post_id"),(String)session.getAttribute("username"),(String)registerReactions.getReactions());
